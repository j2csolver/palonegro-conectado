    ...
    <main>
      <section aria-label="Acerca de Palonegro Conectado" style={{ maxWidth: 700, margin: '2rem auto', padding: '1.5rem' }}>
        ...
        <p style={{ margin: '1rem 0', fontStyle: 'italic', color: '#444' }}>
          Este trabajo fue elaborado como parte del curso Prestación del Servicio Social Unadista, perteneciente a la Escuela de Ciencias Básicas, Tecnología e Ingeniería (ECBTI) de la Universidad Nacional Abierta y a Distancia (UNAD).
        </p>
        <h3>Créditos</h3>
        <ul>
